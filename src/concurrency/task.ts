...
const normalizeTimeout = (timeout?: number): number | undefined => {
...
const validateTaskHandler = <TInput, TResult>(handler: WorkerTaskHandler<TInput, TResult>): string => {
...
const restoreWorkerError = (payload: SerializedWorkerError | undefined): TaskWorkerError => {
...
const createWorkerInstance = (scriptSource: string, name?: string): Worker => {
