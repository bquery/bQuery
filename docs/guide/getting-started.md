...
import { runTask, createTaskWorker, isConcurrencySupported } from '@bquery/bquery/concurrency';
...
| **Concurrency** | Zero-build worker task execution with support checks, aborts, timeouts, and reusable workers |
