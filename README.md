...
| **Router**    | SPA routing, navigation guards, history API    | ~2.1 KB     |
| **Store**     | Signal-based state management, persistence     | ~2.4 KB     |
| **View**      | Declarative DOM bindings, directives           | ~2.2 KB     |
